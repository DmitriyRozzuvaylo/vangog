...
public class Camera2FragmentHandler extends Fragment
	 ...
	 */
	private static final String TAG = "Camera2FragmentHandler";
	...
	public static Camera2FragmentHandler newInstance() {
		return new Camera2FragmentHandler();
	}
	...
	/**
	 * Opens the camera specified by {@link Camera2FragmentHandler#mCameraId}.
	 */
